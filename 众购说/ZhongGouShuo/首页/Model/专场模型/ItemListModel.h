...
@property (nonatomic,copy)NSString *itemList_id;

@property (nonatomic,copy)NSString *img; // https://img.alicdn.com/bao/uploaded/i1/TB1jacRKFXXXXXXXVXXXXXXXXXX_!!0-item_pic.jpg_300x300.jpg
...
@property (nonatomic,copy)NSArray *item_brand; // [],

@property (nonatomic,strong)ItemCateModel *item_cate; // {}

@property (nonatomic,copy)NSArray *item_img; // [],
...
@property (nonatomic,copy)NSString *url; //http://www.tuancu.com/proview-210757.html
@property (nonatomic,copy)NSString *url_h5; //http://www.tuancu.com/jump-210757.html

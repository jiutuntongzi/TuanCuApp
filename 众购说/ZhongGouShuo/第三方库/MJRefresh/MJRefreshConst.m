...
NSString *const MJRefreshHeaderRefreshingText = @"正在刷新数据...";

NSString *const MJRefreshAutoFooterIdleText = @"点击或上拉加载更多商品";
NSString *const MJRefreshAutoFooterRefreshingText = @"正在加载更多的商品...";
NSString *const MJRefreshAutoFooterNoMoreDataText = @"商品已经全部加载完毕";
